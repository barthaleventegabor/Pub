...
use Illuminates\Support\Facades\Gate;
...
class ReservePolicy
{
    ...
    public function viewAny(?User $user) {
        // if ($user->tokenCan("reserve:read") && $user->id === $reserves->user_id) {
        return Response::allow();
    //     } 
    //     return Response::deny("Nincs jogosultságod megtekinteni ezt a foglalást.");
    }
